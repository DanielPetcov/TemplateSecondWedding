...
export default function InvitationCard({ className }: { className?: string }) {
  return (
    <div className={cn("w-full mx-auto", className)}>
      <div className={cn("bg-background-3 text-white rounded-md py-30")}>
        <div className="max-w-xl mx-auto space-y-20">
          ...
          <Link href="/rsvp">
            <Button className="rounded-full text-xl w-full py-10 bg-background-5 hover:bg-white text-black">
              RSVP
            </Button>
          </Link>
        </div>
